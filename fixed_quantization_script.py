...
def main(args):  # Fixed: was "mian"
    ...
    # Fixed: Set stop_file early to avoid undefined variable error
        ...
        if not os.path.isfile(stop_file) and not abort:
            ...
            try:
                ...
                try:
                    ...
                    # Handle user interrupt - Fixed: use shutil.rmtree for non-empty directories
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dtype', type=str, choices=['float16', 'float32', 'bfloat16'], 
                        default='float16', help='Data type for quantization processing')  # Fixed: added default and proper help
